...
from snblog.forms import CommentForm
from snblog.models import Post, Comment
...
def post_list(request, tag_slug=None):
    ...
    return render(request, 'snblog/posts.html', {'posts': posts,
                                                   'page': page,
                                                   'tag': tag})
...
def post_detail(request, pk):
    ...
    return render(request, 'snblog/post.html', {'post': post,
                                                     'comments': comments,
